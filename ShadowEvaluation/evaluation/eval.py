...
from config import SBU_test_pth, BDRAR_SBU_Detection, Direction_SBU_Detection, Distraction_SBU_Detection,ADNet_SBU_Detection
...
to_predictions = {'Direc_SBU_Detection': Direction_SBU_Detection,
                  ...
                  'ADNet_SBU_Detection': ADNet_SBU_Detection}
...
if __name__ == '__main__':
    ...
    # for the evaluation of the input
    # file_list = open("/home/wilson/DE/Python/ADNET_demo-master/out/file_list.txt", "r")
    # name_list = file_list.readlines()
    # name_change = {}
    # for i in range(len(name_list)):
    #     name_ori = name_list[i].split(" : ")
    #     name_change.update({str(name_ori[1].strip('\n')): int(name_ori[0])})
    ...
    for name, label_root in to_test.items():
        ...
        for idx, img_name in enumerate(img_list):
            ...
            for method_name, prediction_root in to_predictions.items():
                ...
                # for evaluation of the input image
                # temp_number = name_change[img_name[:-4] + '.jpg']
                # if temp_number >= 305:
                #     temp_number = temp_number+1
                #
                # if temp_number == 0:
                #     temp_number = 305
                # img_name = str(temp_number) + '.png'
